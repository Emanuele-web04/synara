...
export const ConnectedRepositoryId = makeEntityId("ConnectedRepositoryId");
export type ConnectedRepositoryId = typeof ConnectedRepositoryId.Type;
export const CloudWorkspaceId = makeEntityId("CloudWorkspaceId");
export type CloudWorkspaceId = typeof CloudWorkspaceId.Type;
export const CloudTaskId = makeEntityId("CloudTaskId");
export type CloudTaskId = typeof CloudTaskId.Type;
