...
The available tools are list_apps, get_app_state, click, perform_secondary_action, scroll, drag, run_sequence, type_text, press_key, and set_value. When the MCP host has already connected this server, call these tools directly (for example via use_tool as dothething__get_app_state). Do not spend turns on search_tool or tool_search discovery loops.
