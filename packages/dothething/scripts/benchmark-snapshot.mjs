#!/usr/bin/env node
/**
 * Quick dothething snapshot timing benchmark (macOS).
 * Usage: node packages/dothething/scripts/benchmark-snapshot.mjs [appName]
 */
...
const binary = path.join(packageRoot, "dist/Do The Thing.app/Contents/MacOS/DoTheThing");
...
console.log(`dothething benchmark — app=${app}`);
console.log(
