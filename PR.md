...
- Added a browser regression that keeps the composer inside the centered landing stack.

## Reference findings

The supplied recordings were decoded frame by frame before implementation.

- Synara reference: `Screen Recording 2026-09-24 at 14.06.58.mov` — 1,038 frames, about 20.27 seconds.
...
- `bun run --cwd apps/web test:browser -- src/components/ChatView.browser.tsx` — 1 file and 140 tests passed.
...
- `docs: record home polish verification`
