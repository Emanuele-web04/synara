export const meta = {
  ...
  description:
    "Compare the codex agent harness local vs Daytona cloud across config/instructions, transport I/O, env/tools, approval+sandbox mode, workspace state, and binary/version/model — to explain why the agent behaves differently and how to align them",
  phases: [
    {
      title: "Compare",
      detail: "parallel per-dimension local-vs-cloud diff with live host+sandbox probing",
    },
    {
      title: "Synthesize",
      detail: "rank the differences that change behavior + an alignment plan",
    },
  ],
};
