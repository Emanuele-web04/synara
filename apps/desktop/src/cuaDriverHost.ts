...
const CUA_DRIVER_MISSING_MESSAGE =
  "Cua Driver is not bundled. Run `node apps/desktop/scripts/provision-cua-driver.mjs` in this checkout (needs the pinned Rust toolchain), then relaunch Synara.";
