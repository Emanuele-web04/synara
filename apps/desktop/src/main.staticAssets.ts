// FILE: main.staticAssets.ts
// Purpose: Resolve and validate desktop custom-protocol requests against the bundled static client.
// Layer: Desktop main process
// Exports: resolveDesktopStaticPath, isStaticAssetRequest.
