...
import { DOTHETHING_BROWSER_TOOL_ROUTING_INSTRUCTIONS } from "@t3tools/shared/dothething";
...
</collaboration_mode>${CODEX_BROWSER_TOOL_ROUTING_INSTRUCTIONS}${DOTHETHING_BROWSER_TOOL_ROUTING_INSTRUCTIONS}`;
