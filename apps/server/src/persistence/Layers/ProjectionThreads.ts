...
const ProjectionThreadDbRow = ProjectionThread.mapFields(
  Struct.assign({
    ...
    manualTitlePinned: SqliteBoolean,
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.isPinned ? 1 : 0},
          ${row.manualTitlePinned ? 1 : 0},
          ${row.titleRefreshMode ?? null},
          ${row.pendingSuggestedTitle ?? null},
        ...
        DO UPDATE SET
          ...
          manual_title_pinned = excluded.manual_title_pinned,
          title_refresh_mode = excluded.title_refresh_mode,
          pending_suggested_title = excluded.pending_suggested_title,
    ...
    execute: ({ threadId }) =>
      sql`
        SELECT
          ...
          manual_title_pinned AS "manualTitlePinned",
          title_refresh_mode AS "titleRefreshMode",
          pending_suggested_title AS "pendingSuggestedTitle",
