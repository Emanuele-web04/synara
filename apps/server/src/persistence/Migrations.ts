...
import Migration0056 from "./Migrations/056_ClearAutomationDefinitionProviderOptions.ts";
import Migration0057 from "./Migrations/057_ClearAutomationRunProviderOptions.ts";
...
export const migrationEntries = [
  ...
  [56, "ClearAutomationDefinitionProviderOptions", Migration0056],
  [57, "ClearAutomationRunProviderOptions", Migration0057],
] as const;
