// FILE: 109_ScrubOrchestrationEventProviderOptions.test.ts
...
layer("109_ScrubOrchestrationEventProviderOptions", (it) => {
      ...
      const events = [
        {
          ...
          payload: {
            ...
            modelSelection: { instanceId: "droid_work", model: "droid/auto" },
            providerOptions: {
              droid: {
