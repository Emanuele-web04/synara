...
import threadTitleRefreshSchema from "./104_ThreadTitleRefresh.ts";
  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        // Current projector readers require later additive schemas. Install them
        // without changing the migration-99 tracker state under test.
        yield* messageTextChunkSchema;
        yield* messageTurnBoundarySchema;
        yield* threadTitleRefreshSchema;
