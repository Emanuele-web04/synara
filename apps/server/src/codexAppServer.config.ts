// Purpose: Static configuration for the Codex app-server integration — ANSI/log
//   parsing regexes, benign-output snippet lists, model/plan constants, and the
//   developer-instruction prompt strings for Codex collaboration modes.
// Layer: Pure constants. No process handles, no manager state, no I/O.
// Exports: ANSI/stderr/process regexes and snippet arrays, model/plan/idle
//   constants, and CODEX_PLAN_MODE_DEVELOPER_INSTRUCTIONS /
//   CODEX_DEFAULT_MODE_DEVELOPER_INSTRUCTIONS.
import type { CodexPlanType } from "./codexAppServer.types.ts";
