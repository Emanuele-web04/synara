import {
  ...
  ProjectSourcesUpdatedPayload as ContractsProjectSourcesUpdatedPayloadSchema,
...
export const ProjectSourcesUpdatedPayload = ContractsProjectSourcesUpdatedPayloadSchema;
