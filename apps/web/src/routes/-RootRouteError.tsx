// FILE: -RootRouteError.tsx
// Purpose: Root route error boundary view and its error-formatting helpers.
// Layer: Root route component
// Exports: RootRouteErrorView for the router errorComponent.
