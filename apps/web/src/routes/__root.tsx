...
function RootRouteView() {
  ...
  // Single mount point for Linux renderer caption buttons. Windows uses native overlay
  // controls; macOS keeps native traffic lights. It is safe to mount this fallback
  // unconditionally — including on
