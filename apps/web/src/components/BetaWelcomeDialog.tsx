...
const WELCOME_POINTS = [
  ...
  {
    icon: "heart",
    text: "Beta sends crash reports and anonymous usage counts — never your chats, code, files, or keys on purpose. Crash snapshots can't be redacted, so they're deleted after 90 days.",
  },
