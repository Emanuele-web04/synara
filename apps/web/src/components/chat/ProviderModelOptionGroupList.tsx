      ...
      trailing={
        supportsFavorites ? (
          ...
          <span
            ...
            className="shrink-0 text-ui-xs font-medium tabular-nums text-muted-foreground/80"
          >
      ...
      {preserveChildLayout ? (
        ...
        >
          ...
          {provenanceLabel ? (
            <span
              aria-hidden="true"
              className="block min-w-0 truncate text-ui-xs leading-tight text-muted-foreground/80"
            >
              {provenanceLabel}
            </span>
          ) : null}
  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen} className="px-0.5">
      ...
      >
        ...
        <span className="col-start-3 shrink-0 justify-self-end rounded-full bg-[color-mix(in_srgb,var(--foreground)_6%,transparent)] px-1.5 py-px text-ui-2xs font-normal tabular-nums normal-case tracking-normal text-muted-foreground/80">
