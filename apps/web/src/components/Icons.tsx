...
// Provider brand glyphs live in @synara/profile-ui (shared with the public profile
// page); re-exported here under their historical names so call sites keep working.
export {
  AntigravityIcon,
  ClaudeIcon as ClaudeAI,
  CursorIcon,
  DevinIcon,
  DroidIcon,
  GrokIcon,
