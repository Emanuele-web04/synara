      ...
      >
        <TooltipPrimitive.Popup
          className={cn(
            ...
            "flex h-(--popup-height,auto) w-(--popup-width,auto) origin-(--transform-origin) text-balance text-ui-sm transition-[width,height,scale,opacity] duration-150 ease-smooth-out data-ending-style:scale-98 data-starting-style:scale-98 data-ending-style:opacity-0 data-starting-style:opacity-0 data-instant:duration-0",
