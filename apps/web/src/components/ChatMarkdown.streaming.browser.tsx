...
describe.each(modes)("Streaming identity (%s)", (directionMode) => {
  it("keeps the code block and soft wrap while prose streams after it", async () => {
    const screen = await render(
      <ChatMarkdown directionMode={directionMode} text={fenced} cwd={undefined} isStreaming />,
    );
