...
export function useKanbanBoard(): KanbanBoard {
  ...
  // Group containers are intentionally excluded: a group coordinates chats rather
  // than owning a task board, and its threads surface on the Groups view, not Kanban.
