// FILE: Sidebar.logic.sorting.ts
// Purpose: Timestamp-based thread/project sort and post-delete fallback helpers for the sidebar.
// Layer: Sidebar logic (pure).
// Exports: sortThreadsForSidebar, sortProjectsForSidebar, getProjectSortTimestamp, getFallbackThreadIdAfterDelete, and the shared sort-input types.
